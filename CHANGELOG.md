...
## [1.78.0](https://github.com/tvrmsmith/no-mistakes/compare/v1.77.1...v1.78.0) (2026-09-18)
...
* **agent:** support agent args override ([#133](https://github.com/tvrmsmith/no-mistakes/issues/133)) ([18c58ae](https://github.com/tvrmsmith/no-mistakes/commit/18c58aef526a7c2b887246e80c9455bbebe27811))
...
* **cli:** add non-interactive setup wizard with --yes ([#105](https://github.com/tvrmsmith/no-mistakes/issues/105)) ([99d2715](https://github.com/tvrmsmith/no-mistakes/commit/99d27152f064a78864dc0fe08392d0d41f545d3f))
...
* **cli:** cache wizard commit subject from branch suggestions ([#117](https://github.com/tvrmsmith/no-mistakes/issues/117)) ([134fadb](https://github.com/tvrmsmith/no-mistakes/commit/134fadb3273e11835bcb43b6d8c8866a14d3575a))
...
* **cli:** keep the setup wizard visible for interactive --yes runs ([#109](https://github.com/tvrmsmith/no-mistakes/issues/109)) ([dffa857](https://github.com/tvrmsmith/no-mistakes/commit/dffa857b721db761c0505ca43af785f4d453f137))
...
* **pipeline:** add testing details to PR summaries ([#104](https://github.com/tvrmsmith/no-mistakes/issues/104)) ([7adb743](https://github.com/tvrmsmith/no-mistakes/commit/7adb743b14033508a4f6f7aa42631d9a0ae6e914))
...
* **tui:** add finding overrides for manual fix rounds ([#135](https://github.com/tvrmsmith/no-mistakes/issues/135)) ([4b62714](https://github.com/tvrmsmith/no-mistakes/commit/4b62714cb55be3a09fe1acd1da1532dea39d2583))
...
* **update:** add beta release channel ([#136](https://github.com/tvrmsmith/no-mistakes/issues/136)) ([907e6e3](https://github.com/tvrmsmith/no-mistakes/commit/907e6e33f44d843915e946b4b26689f6c91fa158))
* **wizard:** show setup progress in terminal title ([#116](https://github.com/tvrmsmith/no-mistakes/issues/116)) ([4d42a7a](https://github.com/tvrmsmith/no-mistakes/commit/4d42a7adabd63c888c1e970829be766897306530))
...
* **daemon:** clean up timed-out daemon startups safely ([#128](https://github.com/tvrmsmith/no-mistakes/issues/128)) ([b6a2389](https://github.com/tvrmsmith/no-mistakes/commit/b6a238921439347e377ed6ed46f4716e95830b6b))
...
* **daemon:** harden orphaned agent server recovery ([#121](https://github.com/tvrmsmith/no-mistakes/issues/121)) ([7600bb7](https://github.com/tvrmsmith/no-mistakes/commit/7600bb7de56772dd67c6e023c5deec2608d0572b))
...
* **daemon:** tighten detached fallback around managed service stop failures ([#115](https://github.com/tvrmsmith/no-mistakes/issues/115)) ([957065a](https://github.com/tvrmsmith/no-mistakes/commit/957065a3637cc0b971eadb8d651ecb95feebc76e))
* **daemon:** update panic error status after telemetry ([#106](https://github.com/tvrmsmith/no-mistakes/issues/106)) ([c188e12](https://github.com/tvrmsmith/no-mistakes/commit/c188e12cf47f144de9ad02a083cccceec315a063))
...
* **git:** isolate gate hooks from shared hookspath changes ([#127](https://github.com/tvrmsmith/no-mistakes/issues/127)) ([a1d5bab](https://github.com/tvrmsmith/no-mistakes/commit/a1d5bab0631ae443d9a83943527613b743e95e3b))
* **git:** move core.bare into worktree config ([#130](https://github.com/tvrmsmith/no-mistakes/issues/130)) ([75f20a9](https://github.com/tvrmsmith/no-mistakes/commit/75f20a9027732ad121244a174f44f1a312b9f9d7))
...
* **pipeline:** harden CI autofix rerun retry guards ([#123](https://github.com/tvrmsmith/no-mistakes/issues/123)) ([ac8cb83](https://github.com/tvrmsmith/no-mistakes/commit/ac8cb8360e0dafb90ac1e0c9b13db041cc65d35f))
...
* **release:** run publish jobs after skipped validation ([#113](https://github.com/tvrmsmith/no-mistakes/issues/113)) ([2fa5d24](https://github.com/tvrmsmith/no-mistakes/commit/2fa5d24850aa4bd1fd3b24693554257b32a9d2e5))
...
* **tui:** backfill rerun pipeline steps without stale placeholders ([#111](https://github.com/tvrmsmith/no-mistakes/issues/111)) ([ae4ae8b](https://github.com/tvrmsmith/no-mistakes/commit/ae4ae8b91cbc7c830a7ce05b5728887d56f6dc67))
...
* **wizard:** render branch step input and status inline ([#108](https://github.com/tvrmsmith/no-mistakes/issues/108)) ([d945e2d](https://github.com/tvrmsmith/no-mistakes/commit/d945e2dbd6130504a9f3e4861ca8f37ef1c0eda2))
* **wizard:** wait for daemon run before attach handoff ([#119](https://github.com/tvrmsmith/no-mistakes/issues/119)) ([ca47098](https://github.com/tvrmsmith/no-mistakes/commit/ca47098b34040a18765d95922eb3158052792f28))
